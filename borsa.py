...
Usa HH=18&MM=00 per ottenere i contratti delle 18:00-18:05
"""
...
def main():
    for titolo in TITOLI:
        isin = titolo["isin"]
        url = (f"{BASE_URL}/borsa/azioni/mercato-serale/contratti.html"
               f"?isin={isin}&mic=MTAH&HH=18&MM=00&lang=it")
        ...
        try:
            ...
            print(f"Contratti trovati: {len(contracts)}")
